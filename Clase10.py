...
"""
#(np.power(df[df['acido']==0]['conductividad'],lambda_opt)-1)/lambda_opt
...
# df['conductividad'] = (np.power(df['conductividad'],lambda_opt)-1)/lambda_opt
...
plt.scatter(df.index, df['Residuos'])
